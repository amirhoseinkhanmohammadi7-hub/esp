...
$quotes = [
    ...
    ['text' => 'مرد بزرگ کسی است که به کودکان امید می‌بخشد.', 'author' => 'ژان پل سارتر'],
    ['text' => 'اگر خورشید را نبینی، سایه خودت می‌شوی.', 'author' => 'ویلیم فاکنر'],
    ['text' => 'همیشه به نظر احمق‌ها توجه نکن.', 'author' => 'ناپلئون هیل'],
    ['text' => 'شجاعت این نیست که نترسی، بلکه این است که با ترس بجنگی.', 'author' => 'نلسون ماندلا'],
    ['text' => 'موفقیت مجموعه‌ای از تلاش‌های کوچک است که هر روز تکرار می‌شوند.', 'author' => 'رابرت کولیر'],
    ['text' => 'زندگی ۱۰٪ اتفاقات است و ۹۰٪ واکنش تو به آن‌ها.', 'author' => 'چارلز سویندول'],
    ...
    ['text' => 'تنها مرز واقعی بین تو و هدفت، داستانی است که برای خودت تعریف می‌کنی.', 'author' => 'مل رابینز'],
    ['text' => 'موفقیت تصادفی نیست، نتیجه انتخاب‌های هوشمندانه است.', 'author' => 'بری ویکس'],
    ...
    ['text' => 'اگر از شکست بترسی، هرگز جرأت امتحان کردن نخواهی داشت.', 'author' => 'باب مارلی'],
    ['text' => 'زندگی کوتاه است، آن را با حسرت پر نکن.', 'author' => 'جوزف کمپبل'],
    ['text' => 'تو نویسنده داستان زندگی خودت هستی.', 'author' => 'ناشناس'],
    ['text' => 'هر روز یک شروع تازه است.', 'author' => 'ناشناس'],
    ['text' => 'پیروزی نهایی نیست، شکست فاجعه‌بار نیست: شجاعت ادامه دادن است که اهمیت دارد.', 'author' => 'وینستون چرچیل'],
    ...
    ['text' => 'موفقیت وقتی است که آمادگی با فرصت ملاقات می‌کند.', 'author' => 'رابرت فریر'],
    ['text' => 'تنها راه خوشبختی این است که به دیگران کمک کنی خوشبخت شوند.', 'author' => 'بنجامین فرانکلین'],
